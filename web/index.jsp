...
<div class="row">
    <div class="col-md-2">
        <div style="width: 250px;margin-top:170px;float:right;background-color: #ECF0FF">
            <ul class="nav nav-pills nav-stacked">
                <li role="presentation" style="font-size: 25px"><a href="#Project Summary">Project Summary</a></li>
                <%--<li role="presentation"><a href="#People">People</a></li>--%>
                <li role="presentation" style="font-size: 25px"><a href="#Subjects">Subjects</a></li>
                <li role="presentation" style="font-size: 25px"><a href="#Feature Request Analyzer Tool">Feature Request Analyzer Tool</a></li>
                <li role="presentation" style="font-size: 25px"><a href="#Evaluation">Evaluation</a></li>
                <li role="presentation" style="font-size: 25px"><a href="#Download">Download</a></li>
            </ul>
        </div>
    </div>
    <div class="col-md-8">
